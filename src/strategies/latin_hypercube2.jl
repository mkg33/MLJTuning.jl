...
"""
mutable struct LatinHypercube2 <: TuningStrategy
    gens::Int
    popsize::Int
    ntour::Int
    ptour::Number
...
function LatinHypercube2(; gens = 1,
                        popsize = 100,
                        ntour = 2,
                        ptour = 0.8,
                        interSampleWeight = 1.0,
    ...
    return LatinHypercube2(gens, popsize, ntour,
...
function setup(tuning::LatinHypercube2, model, range, n, verbosity)
...
function MLJTuning.models(tuning::LatinHypercube2,
                          model,
                          history,
                          state,
                          n_remaining,
...
tuning_report(tuning::LatinHypercube2, history, state) =
